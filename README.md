# Available .VOYAGE One-Word Domains (5,622,096)
...
> **Important:** this repository is a **public 9,585-row extract**, not the full live catalog.
...
- `voyage.csv` — public CSV extract (9,585 rows)
- `voyage.json` — public JSON extract (9,585 rows)
...
| first.voyage     | premium   | $83.99    | $82.50        | 80             | 42     | 5      | name.com                                                  |
